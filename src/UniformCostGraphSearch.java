...
public class UniformCostGraphSearch {
    ...
    public UniformCostGraphSearch(RoomModel startingNode) {
    ...
    public RoomModel ucgs(RoomModel[][] problemSet, List<RoomModel> problemGoals){
        mProblemGoals = problemGoals;

        Date startTime = new Date();
        System.out.println("Starting Uniform Cost Graph Search Algorithm");
        if (problemSet == null) {
